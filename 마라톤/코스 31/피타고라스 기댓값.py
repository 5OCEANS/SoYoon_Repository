...
for _ in range(T):
  teamNum, gameNum = map(int, sys.stdin.readline().strip().split())
  teamsScore = [0 for _ in range(0,teamNum)]
  teamsLosePoint = [0 for _ in range(0,teamNum)]
  W = [0 for _ in range(0,teamNum)]
